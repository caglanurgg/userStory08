...
public class US_08 extends TestBaseRapor {
    ...
    public void login() {
        ...
        userDashboard.emailtextBox.sendKeys(ConfigReader.getProperty("scGecerliEmailCG"));
        extentTest.info("login  pagede email textbox'ına geçerli email girilir.");

        userDashboard.passwordTextBox.sendKeys(ConfigReader.getProperty("scGecerliPasswordCG"));
    ...
    public void testCreateNewVCard() {
        ...
        String vCardName = "cagla";
        userDashboard.enterVCardName.sendKeys(vCardName);
        ...
        // succesfull mesajı için locate alınacak
        String actualMessage = userDashboard.getConfirmationMessage.getText();
    ...
    public void testViewVCardCount() {
        ...
        */
        ...
        // 3.13. Vcard sayfasında en altta bulunan "Showing (x) results" yazısındaki x sayısının arttığı doğrulanır.
        // int initialVCardCount = userDashboard.getVCardCount.getText();
        ...
        Assert.assertTrue(userDashboard.getVCardCount.isDisplayed(), "VCard sayısı doğrulandı.");
    ...
    public void testVerifyVCardActions() {
        ...
        boolean isEditVCardPageDisplayed = userDashboard.isEditVCardPageDisplayed.isDisplayed();
        ...
        Assert.assertTrue(userDashboard.isRedirectedToTemplatesLink.isEnabled(),"Vcard Templates butonuna tıklandığı dogrulandi.");
        ...
        boolean isBusinessHoursLinkRedirected = userDashboard.isRedirectedToBusinessHoursLink.isEnabled();
        ...
        boolean isServicesHoursLinkRedirected = userDashboard.isRedirectedToServicesHoursLink.isEnabled();
        Assert.assertTrue(isServicesHoursLinkRedirected, "Services Hours butonunun ilgili linke yönlendirdiği doğrulandı.");

        // 4.18. Testimonials butonuna basılır ve ilgili linke yönlendirdiği doğrulanır
        // userDashboard.ActionButton.click("Testimonials Hours");
        extentTest.info("Testimonials butonuna tıklanılır.");
        boolean isTestimonialsHoursLinkRedirected = userDashboard.isRedirectedToTestimonialsLink.isEnabled();
        Assert.assertTrue(isTestimonialsHoursLinkRedirected, "Testimonials Hours butonunun ilgili linke yönlendirdiği doğrulandı.");

        // 4.19. Social-Links-Website butonuna basılır ve ilgili linke yönlendirdiği doğrulanır
        // userDashboard.ActionButton.click("Social-Links");
        extentTest.info("Social-Links-Website butonuna tıklanılır.");
        boolean isSocialLinksHoursLinkRedirected = userDashboard.isRedirectedToSocialLinksHoursLink.isEnabled();
        ...
        extentTest.info("Fonts butonuna tıklanılır.");
        boolean isFontsHoursLinkRedirected = userDashboard.isRedirectedToFontsHoursLink.isEnabled();
        ...
        boolean isPrivacyPolicyLinkRedirected = userDashboard.isRedirectedToPrivacyPolicyLink.isEnabled();
        Assert.assertTrue(isPrivacyPolicyLinkRedirected, "Privacy-policy Hours butonunun ilgili linke yonlendirdigi dogrulandi.");

        //4.22.Terms & Conditions butonuna basılır ve ilgili linke yönlendirdiği doğrulanır
        extentTest.info("Terms & Conditions butonuna basilir ve ilgili linke yonlendirdigi dogrulanir");
        boolean isTermsConditionsLinkRedirected=userDashboard.isRedirectedToTermsConditionsLink.isEnabled();
        Assert.assertTrue(isTermsConditionsLinkRedirected,"Terms & Conditions butonunun ilgili linke yonlendirdigi dogrulandi.");
        ...
        for (String buttonName : buttonNames) {
            ...
            Assert.assertTrue(isRedirected, buttonName + " butonunun ilgili linke yonlendirdigi dogrulandi.");
        }
